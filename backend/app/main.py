...
def shaft_location_summary(row):
    return {"id": row["id"], "segmentId": row["segment_id"], "projectId": row["project_id"], "projectCode": row["project_code"], "projectName": row["project_name"], "segmentCode": row["segment_code"], "segmentName": row["segment_name"], "segmentNumber": row["segment_number"], "shaftName": row["shaft_name"], "shaftDisplayName": row["shaft_display_name"], "latitude": row["latitude"], "longitude": row["longitude"], "note": row["note"], "displayOrder": row["display_order"], "updatedAt": row["updated_at"]}
...
def get_segment_shaft_location(segment_id: int):
    with db() as conn:
        ...
        return {"item": {"id": None, "segmentId": row["id"], "projectId": row["project_id"], "projectCode": row["project_code"], "projectName": row["project_name"], "segmentCode": row["code"], "segmentName": row["name"], "segmentNumber": row["segment_number"], "shaftName": row["shaft_name"] or "", "shaftDisplayName": row["shaft_display_name"] or row["name"], "latitude": None, "longitude": None, "note": "", "displayOrder": row["display_order"], "updatedAt": None}}
